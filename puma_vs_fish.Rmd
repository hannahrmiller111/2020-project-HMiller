...
Solution: ____ % of carbon eaten by birds is coming from the lake versus the land
...
#Q3. Let's assume the MeHg in the organic matter in the lake is measured at 4.5 ng/g and that it increases 3X at each trophic level. We know all the carbon consumed by fish comes from the lake, so we can use 4.5 ng/g as the starting concentration. For the puma, though, we know the second trophic level (birds) only takes up a portion (f_aq) of the MeHg so we must factor that in to determine MeHg mobilization into puma. 
