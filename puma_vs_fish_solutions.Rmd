...
rock_etching_info <- tibble(
  ...
  d_13C = c(-13,-14,-15,-29,-28.5,-22,-23,-24),
...
$$
```{r}
f_aq <- ((-24) - (-28.5))/((-13)-(-28.5))
f_aq
```


Solution: 29% of carbon eaten by puma is originally sourced from the lake versus the land
...
```{r}
MeHg_puma <- MeHg * f_aq * 3^puma_troph
MeHg_puma
```
