...
Solution: 44% of carbon eaten by birds is coming from the lake versus the land
...
```{r}
MeHg_puma <- (MeHg*3*f_aq) * 3^(puma_troph - 1)
MeHg_puma
```
...
Fish MeHg = 126 ng/g and puma MeHg = 186 ng/g so you'd want to eat fish. Probably good since you might have other health consequences if you tried to kill a puma with your bare hands. 
